...
Do not describe intended actions when actions can be executed.

Avoid fake progress language:
- "I will investigate"
- "I will analyze"
- "I will look into it"
...
- provide artifacts, outputs, or validated conclusions

A task is not complete because it was discussed.
A task is complete only when:
- the requested action was actually executed
- outputs were validated when possible
